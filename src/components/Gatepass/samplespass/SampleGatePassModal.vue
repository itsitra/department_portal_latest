<template>
  <div
    ...
    <div @click="closeModal" class="ml-800 cursor-pointer absolute top-2 left-44">
    ...
    <div class="overflow-y-auto relative">
      ...
      <form class="p-2 flex flex-col w-full">
        ...
        <div class="flex gap-6">
          <div class="form-control w-60">
            ...
            <div class="flex space-x-2 relative">
              <input type="text" placeholder="Search" class="w-full input focusring input-sm input-bordered"
                v-model="query" />
              <button
          ...
          <div class="form-control w-96">
            <label class="label">
              <span class="label-text font-bold tracking-wide">Search / Select User</span>
            </label>
            <div class="relative flex items-center">
              ...
              <div class="w-full bg-white rounded-md">
                <v-select label="name" :options="cust" v-model="custSelected" class="pl-10"></v-select>
              </div>
            </div>
          </div>
          <div class="form-control w-96">
            <label class="label">
              <span class="label-text font-bold tracking-wide">Staff Name
            ...
            <div class="relative flex items-center">
              ...
              <select v-model="staffName" class="select select-bordered w-full pl-12 focusring select-sm">
                <option v-for="(staff, i) in staffs" :key="i" :value="staff.Staff_Code">
                  {{ staff.Staff_Name }}
                </option>
              </select>
            </div>
        ...
        <div class="grid grid-cols-5 gap-2">
          <div class="form-control">
            <label class="label">
              <span class="label-text font-bold tracking-wide">Transport Mode</span>
            </label>
            <div class="relative flex items-center">
              <div class="absolute border-r-2 border-blue-400 py-1 px-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
              ...
              <input v-model="transportMode" type="text" placeholder="." name="transportMode"
          ...
          <div class="form-control">
            <label class="label">
              <span class="label-text font-bold tracking-wide">Transport Company</span>
            </label>
            <div class="relative flex items-center">
              <div class="absolute border-r-2 border-blue-400 py-1 px-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
              ...
              <input v-model="transportCompany" type="text" name="transportCompany" placeholder="."
                class="input input-bordered w-full pl-12 pr-5 focusring input-sm" />
            </div>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text font-bold tracking-wide">Vechile No</span>
            </label>
            <div class="relative flex items-center">
              <div class="absolute border-r-2 border-blue-400 py-1 px-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
              ...
              <input v-model="vechileNo" type="text" name="vehicleNo" placeholder="."
                class="input input-bordered w-full pr-5 pl-12 focusring input-sm" />
            </div>
          </div>
          <div class="form-control">
            <label class="label">
              <span class="label-text font-bold tracking-wide">No of Items</span>
            </label>
            <div class="relative flex items-center">
              <div class="absolute border-r-2 border-blue-400 py-1 px-2">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24"
              ...
              <input readonly="readonly" v-model="noOfItems" type="number" placeholder="No of items"
          ...
          <!-- <div class="form-control">
            <label class="label">
              <span class="label-text font-bold tracking-wide"
                >Purpose <strong class="text-red-600 font-bold">*</strong></span
              >
            </label>
            <div class="relative flex items-center">
              <div class="absolute border-r-2 border-blue-400 py-1 px-2">
          ...
          <div class="form-control">
            ...
            <div class="relative flex items-center">
              ...
              <input v-model="dcnumber" type="text" placeholder="Dc# and Date" name="Dc# and Date"
                class="input input-bordered w-full pl-12 focusring input-sm" />
            </div>
          </div>
          <div class="form-control col-span-5">
            ...
            <div class="relative">
              ...
              <textarea v-model="remarks" name="supplierAddress"
      ...
      <div class="grid grid-flow-col gap-4">
        <div class="form-control">
          ...
          <div class="relative flex items-center">
            ...
            <!-- <div class="w-full bg-white rounded-md">
              <v-select label="inwardno" :options="inwardno" v-model="description" class="pl-10"></v-select>
            </div> -->
            <select v-model="description" class="select select-bordered select-sm focusring pl-12 w-full">
              <option v-for="(no, i) in inwardno" :key="no.inwardno" :value="no.inwardno" class="select select-xs"
                @click="getNoofSample(i)">
                {{ no.inwardno }}
              </option>
            </select>
            <!-- <input
              ...
              class="input input-bordered focusring pl-12 input-sm w-full"
            /> -->
          </div>
        </div>
        ...
        <div class="form-control">
          <label class="label">
            <span class="label-text font-bold tracking-wide">Unit <strong
          ...
          <div class="relative flex items-center">
            ...
            /> -->
            <select v-model="unit" class="select select-bordered select-sm focusring pl-12 w-full">
        ...
        <div class="form-control">
          <label class="label">
            <span class="label-text font-bold tracking-wide">Quantity <strong
                class="text-red-600 font-bold">*</strong></span>
          </label>
          <div class="relative flex items-center">
            <div class="absolute border-r-2 border-blue-400 py-1 px-2">
            ...
            <input v-model="quantity" type="number" placeholder="Quantity" readonly
              class="input input-bordered focusring pl-12 input-sm w-full" />
          </div>
        </div>
        <!-- <div class="form-control">
        ...
        <div class="form-control mt-9">
          <input @click="addLineEntry" class="btn bg-theme-black text-theme-green btn-sm" type="button" value="Add" />
        </div>
      </div>
      ...
      <div class="overflow-x-auto mt-12 h-full">
        <table class="table w-full table-compact">
          ...
          <tbody>
            <tr v-for="(line, i) in lineEntries" :key="i" class="">
              <th>{{ i + 1 }}</th>
              <td>
                <input v-model="lineEntries[i].description" type="text" :readonly="lineEdit" />
              </td>
              <td>
                <input v-model="lineEntries[i].unit" type="text" :readonly="lineEdit" />
              </td>
              <td>
                <input v-model="lineEntries[i].quantity" type="number" :readonly="lineEdit" />
              </td>

              <td class="cursor-pointer flex gap-4">
                <span @click="lineEditOpt">
                  <svg xmlns="http://www.w3.org/2000/svg" :class="[lineEdit ? 'h-6 w-6' : 'h-6 w-6 text-red-500']"
...
export default {
  ...
  setup(props) {
    const {
      ...
      remarks,
      userCheck,
      getNoofSample, inwardSelected, inwardno, getInward,
      cust,
      queryLoading,
      query,
      custSelected,
    ...
    watch(custSelected, (curent) => {

      getInward(curent.custid)
    })


    const saveData = () => {
      if (lineEntries.value.length !== 0) {
        if (staffName.value.length !== 0) {
          let data = {
            ...
            transportMode:
              transportMode.value.length == 0
                ? document.getElementsByName("transportMode")[0].placeholder
                : transportMode.value,
            transportCompany:
              transportCompany.value.length == 0
                ? document.getElementsByName("transportCompany")[0].placeholder
                : transportCompany.value,
            vehicleNo:
              vechileNo.value.length == 0
                ? document.getElementsByName("vehicleNo")[0].placeholder
                : vechileNo.value,
          ...
          //       ? document.getElementsByName("purpose")[0].placeholder
          //       : purpose.value,
        ...
        alert("Need Atleast One Item, In order to create a gatepass");
      }
    };
    ...
    return {
      ...
      query,
      getCustData,
      units, getNoofSample, inwardSelected, inwardno, getInward,
    };
  },
};
</script>
