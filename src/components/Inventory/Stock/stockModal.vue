    ...
    >
      ...
      <form class="p-2" @submit.prevent="save">
        <div class="grid grid-cols-3 gap-4 mt-4 grid-rows-2">
          ...
          <div class="form-control">
            ...
            <div class="relative flex items-center">
              ...
              <!-- <input
                ...
                type="text"
                readonly
                placeholder="fromDepartmentname"
                class="
          ...
          <div class="flex items-center mt-7 justify-center col-start-2">
            <input
...
export default {
  ...
  setup(props) {
    const { getItemData, itemData } = consumption();
    const { depName } = useStockTable();
    const {
      fromDep,
      toDep,
      itemCode,
    ...
    const save = () => {
      let d = {
        ...
        fromDeptCode: fromDep.value,
        toDeptCode: toDep.value,
        createdDate:
          date.getFullYear() +
          "-" +
          (date.getMonth() + 1) +
