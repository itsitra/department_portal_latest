...
const sendMail = (d) => {
  let jdata = JSON.stringify({
    toemail: d.toemail,
    subject: "Gate pass generated and waiting for approval",
    message: "Gatepass waiting for approval",
  });
  // console.log(jdata);
  axios
    .post(
      `http://sitraonline.org.in/onlineserviceapi/index.php/api/sendmail`,
      jdata
    )
    .then((res) => {
      // console.log(res);
